...
const DB_NAME = process.env.MONGODB_DB || "maharishi";

export const isDbConfigured = () => Boolean(URI);

let cached = globalThis.__maharishiMongo;
if (!cached) cached = globalThis.__maharishiMongo = { conn: null, promise: null };
