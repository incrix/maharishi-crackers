...
export async function generateMetadata({ params }) {
  ...
  return {
    ...
    keywords: [
      ...
      `${product.category} crackers`, "Sivakasi crackers", "Maharishi Crackers fireworks",
...
export default async function ProductPage({ params }) {
  ...
  const schema = {
    ...
    brand: { "@type": "Brand", name: "Maharishi Crackers" },
    offers: {
      "@type": "Offer",
      url,
      priceCurrency: "INR",
  ...
  const faqs = [
    {
      ...
      a: `${product.name} is ₹${price} at Maharishi Crackers, ${product.discount}% below the list price of ₹${product.price}. Orders are submitted here and confirmed over the phone within a day.`,
    },
    {
