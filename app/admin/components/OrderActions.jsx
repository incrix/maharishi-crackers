...
export default function OrderActions({ order, onToast }) {
  ...
  const WA_TEMPLATES = [
    ...
    },
    {
      ...
      text: `Hello ${c.name}, your Maharishi Crackers order ${order.ref} (${inr(order.total)}) has been dispatched. We'll share delivery details shortly.\n\nThank you for shopping with us!`,
    },
  ];
  ...
  const downloadInvoice = async () => {
    ...
    try {
      ...
      a.href = url;
      a.download = `Proforma-${order.ref}.pdf`;
