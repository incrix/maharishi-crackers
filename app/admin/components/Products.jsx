              ...
              <Tooltip key={v.key} title={v.label}>
                <IconButton
                  ...
                  sx={{
                    ...
                    "&:hover": { backgroundColor: layout === v.key ? "var(--primary-dark)" : "#e2dbcb" },
                  }}
                >
                  {v.icon}
                </IconButton>
          ...
          <>
            {layout === "grid" ? (
                    ...
                    <Box sx={{ position: "relative" }}>
                      <Box component="img" src={assetUrl(p.image?.[0])} alt=""
                        sx={{ width: "100%", aspectRatio: "1 / 1", objectFit: "cover",
                              borderRadius: "var(--radius-sm)", backgroundColor: "#f4f0e6", display: "block" }} />
              ...
              <Stack key={p.id} direction="row" alignItems="center" gap={1.5} data-product-row={p.id}
                ...
                <Box component="img" src={assetUrl(p.image?.[0])} alt=""
                  sx={{ width: 46, height: 46, borderRadius: "var(--radius-sm)", objectFit: "cover", flexShrink: 0, backgroundColor: "#f4f0e6" }} />
