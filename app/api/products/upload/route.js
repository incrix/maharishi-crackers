 ...
 *
 * Three tiers, in order of preference: Cloudinary (CDN-delivered, and it
 * resizes on the fly), then S3, then the local filesystem. public/uploads only
 * works where the filesystem persists — on a serverless host it is read-only
 * and wiped between deploys.
 */
